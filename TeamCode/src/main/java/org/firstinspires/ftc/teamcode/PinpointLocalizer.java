...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 315.976; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2596.0566; // x position of the perpendicular encoder (in tick units)
        // TODO: Set parYTicks and PerpXTicks ASAP
    }
